...
namespace MyMorApi.Controllers
{
    ...
    {
        readonly IAnnouncementService _service;
        ...
        [HttpPost]
        [Route("Get")]
        public async Task<IActionResult> Get(AnnouncementModel model)
        {
        ...
        [HttpPost]
        [Route("Update")]
        public async Task<IActionResult> Update(AnnouncementModel model)
        {
        ...
        [HttpPost]
        [Route("Delet")]
        public async Task<IActionResult> Delete(AnnouncementModel model)
        {
